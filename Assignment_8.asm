...
mov  rsi , %1  ; address of string to write
mov  rdx , %2  ; no. of bytes to write
syscall
%endmacro
...
write   arg_input       , 01           ; write arg_input
write   line_br         , 01           ; next line
...
write   fact_output       , 02            ; write the factorial
